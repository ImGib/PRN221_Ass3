...
namespace _26_TranGiaBao_Ass3.Controllers
{
    public class PostCategoriesController : Controller
    {
        ...
        public PostCategoriesController(SignalRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.PostCategories != null ? 
                          ...
                          Problem("Entity set 'SignalRContext.PostCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SignalRContext.PostCategories'  is null.");
            }
            var postCategories = await _context.PostCategories.FindAsync(id);
            if (postCategories != null)
            {
